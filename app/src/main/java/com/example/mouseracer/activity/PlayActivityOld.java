...
public class PlayActivityOld extends BaseActivity implements View.OnClickListener, VerticalSeekBar
        .SlideChangeListener, MyLinearLayout.LinearChangeListener, BleManagerCallbacks, OldMouseManager.Disconnncet {
    ...
    public static void start(Context context) {
        Intent starter = new Intent(context, PlayActivityOld.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OldMouseManager.getInstance(this).setBattery(horizontalBattery);
        OldMouseManager.getInstance(this).setGattCallbacks(this);
        OldMouseManager.getInstance(this).setDisconncetListenser(this);
    ...
    public void onDeviceDisconnected(BluetoothDevice device) {
        OldMouseManager.getInstance(this).connect(device);
    }
...
//        OldMouseManager.getInstance(this).connect();
//        ToastUtil.showMessage("device is close or device is not exist!!");
        //   finish();
    }

    public static class MyMainHandler extends Handler {
        WeakReference<PlayActivityOld> mActivityReference;

        MyMainHandler(PlayActivityOld activity) {
    ...
    private void writeData(String cmd, int speed) {
        ...
        OldMouseManager.getInstance(this).writeData(hexStringToBytes(data));
    }
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("sure", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            myMainHandler.removeCallbacks(task);
                            OldMouseManager.getInstance(PlayActivityOld.this).close();
                            OldMouseManager.getInstance(PlayActivityOld.this).disconnect();
                            finish();
                        }
